...
percibe bien), tiene un problema de experiencia física y humana en el local. 
Las inversiones con mayor retorno esperado son: renovación de instalaciones 
(A/C, espacio, limpieza) y capacitación del personal de atención.
